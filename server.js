...
var DATA_FILE = join2(DATA_DIR, "data.json");
var PORT = parseInt(process.env.PORT || "3000");
var DIST_DIR = process.env.DIST_DIR || "./dist";
if (!existsSync2(DATA_DIR)) mkdirSync(DATA_DIR, { recursive: true });
var app = new Hono2();
app.get("/api/data", (c) => {
  if (!existsSync2(DATA_FILE)) return c.body("null", { headers: { "content-type": "application/json" } });
  const raw2 = readFileSync(DATA_FILE, "utf-8");
  return c.body(raw2, { headers: { "content-type": "application/json" } });
});
...
app.get("*", (c) => {
  const html = readFileSync(join2(DIST_DIR, "index.html"), "utf-8");
  return c.html(html);
});
